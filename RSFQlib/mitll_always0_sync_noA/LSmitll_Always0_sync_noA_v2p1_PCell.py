...
class PCELL(spira.PCell):
    ...
    def create_elements(self, elems):
        R1 = spira.SRef(ls_res_2(),transformation=r270,midpoint=(0.73*tp,5.495*tp))
        R2 = spira.SRef(ls_res_2(),midpoint=(1.5*tp,1.64*tp))
        ...
        ## Inductors
        L1 = spira.RoutePath(port1=PCLK,port2=PJ1,path=[((PCLK.x+PJ1.x)/2,(PCLK.y+PJ1.y)/2)],start_straight=False,end_straight=False,width=L1_width,layer=M6)
        L2 = spira.RoutePath(port1=PJ1,port2=PR1E,path=[((PJ1.x+PR1E.x)/2,(PJ1.y+PR1E.y)/2)],start_straight=False,end_straight=False,width=L2_width,layer=M6)
        L3 = spira.RoutePath(port1=PR1W,port2=PCLK_end,path=[((PR1W.x+PCLK_end.x)/2,(PR1W.y+PCLK_end.y)/2)],start_straight=False,end_straight=False,width=L3_width,layer=M6)
        L4 = spira.RoutePath(port1=PQ,port2=PJ2,path=[(2.5*tp,PQ.y),(2.5*tp,PJ2.y)],start_straight=False,end_straight=False,width=L4_width,layer=M6)
        L5 = spira.RoutePath(port1=PJ2,port2=PR2N,path=[((PJ2.x+PR2N.x)/2,(PJ2.y+PR2N.y)/2)],start_straight=False,end_straight=False,width=L5_width,layer=M6)
        L6 = spira.RoutePath(port1=PR2S,port2=PQ_end,path=[((PR2S.x+PQ_end.x)/2,(PR2S.y+PQ_end.y)/2)],start_straight=False,end_straight=False,width=L6_width,layer=M6)
        elems += [L1, L2, L3, L4, L5, L6]
        
        LB1_1 = spira.RoutePath(port1=PJ1,port2=PB1N,path=[(PB1N.x,PJ1.y)],start_straight=False,end_straight=False,width=LB_width,layer=M6)
        LB1_2 = spira.RoutePath(port1=PB1S,port2=PBP,path=[(PB1S.x,PBP.y)],start_straight=False,end_straight=False,width=LB_width,layer=M6)
        LB2_1 = spira.RoutePath(port1=PJ2,port2=PB2S,path=[(PB2S.x,PJ2.y)],start_straight=False,end_straight=False,width=LB_width,layer=M6)
        LB2_2 = spira.RoutePath(port1=PB2N,port2=PBP,path=[((PB2N.x+PBP.x)/2,(PB2N.y+PBP.y)/2)],start_straight=False,end_straight=False,width=LB_width,layer=M6)
...
class junction_fill(spira.Cell):
    ...
    def create_elements(self, elems):
        ...
        elems += spira.SRef(ls_FakeJJ_3umx3um(),midpoint=(1.5*tp,3.5*tp))
...
class M4M5M6M7_connections(spira.Cell):
    ...
    def create_elements(self, elems):
        ...
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(1.335*tp,3.845*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(1.335*tp,1.41*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(2.335*tp,3.735*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(2.335*tp,5.81*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(1.335*tp,4.125*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(0.335*tp,5.93*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(2.335*tp,4.09*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(2.335*tp,2.025*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(0.335*tp,4.845*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(0.57*tp,5.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(1.155*tp,3.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(2.875*tp,4.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(2.875*tp,5.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(1.875*tp,6.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(1.265*tp,6.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(0.265*tp,5.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(2.875*tp,2.335*tp))
        ...
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(2.155*tp,6.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(2.195*tp,3.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(0.875*tp,3.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(0.265*tp,3.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(0.265*tp,2.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(0.165*tp,4.335*tp))
        elems += spira.SRef(ls_conn_M5M6M7(),midpoint=(1.465*tp,2.995*tp))
        elems += spira.SRef(ls_conn_M5M6M7(),transformation=m0,midpoint=(1.465*tp,5.005*tp))
...
class biasing(spira.Cell):
    ...
    def create_elements(self, elems):
        elems += spira.SRef(ls_ib_175(),midpoint=(0.5*tp,2.495*tp),alias='bias2')
        elems += spira.SRef(ls_ib_175(),midpoint=(2.5*tp,4.48*tp),alias='bias1')
        return elems

class junctions(spira.Cell):
    __name_prefix__ = "junctions"
    def create_elements(self, elems):
        elems += spira.SRef(ls_jj_250_sg(),midpoint=(1.5*tp,2.5*tp),alias='J2')
        elems += spira.SRef(ls_jj_250_sg(),transformation=r180,midpoint=(1.5*tp,5.5*tp),alias='J1')
        return elems
