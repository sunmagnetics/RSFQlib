...
class PCELL(spira.PCell):
    __name_prefix__ = "THmitll_ALWAYS0T_ASYNC_v3p0"
    def create_elements(self, elems):
        ...
        elems += spira.Label(text='a',position=(0.500*tp,3.500*tp),layer=spira.Layer(number=60,datatype=5))
...
class IX_ports(spira.Cell):
    ...
    def create_elements(self, elems):
        ...
        elems += spira.Box(layer=IXPORT,width=0.160*tp,height=0.000*tp,center=(0.500*tp,3.150*tp),alias='A')
...
class M4M5M6M7_connections(spira.Cell):
    ...
    def create_elements(self, elems):
        ...
        elems += spira.SRef(conns.conn_M4M5M6M7(),midpoint=(0.665*tp,2.205*tp),transformation=ls.r180,alias='AZERO')
...
class trackblocks(spira.Cell):
    ...
    def create_elements(self, elems):
        ...
        elems += spira.SRef(tb.tr_PTLconnection(),midpoint=(0.000,0+3.000*tp),alias='A')
        return elems
