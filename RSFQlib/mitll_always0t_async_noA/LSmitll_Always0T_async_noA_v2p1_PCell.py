...
class junction_fill(spira.Cell):
    ...
    def create_elements(self, elems):
        ...
        elems += spira.SRef(ls_FakeJJ_3umx3um(),midpoint=(0.5*tp,3.31*tp))
...
class M4M5M6M7_connections(spira.Cell):
    ...
    def create_elements(self, elems):
        ...
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(0.32*tp,2.745*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(0.32*tp,2.375*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(0.32*tp,1.42*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(0.68*tp,3.855*tp),transformation=T)
