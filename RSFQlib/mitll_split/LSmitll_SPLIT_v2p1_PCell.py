...
class PCELL(spira.PCell):
    ...
    def create_elements(self, elems):
        ...
        L2 = spira.RoutePath(port1=PJ1,port2=PJ2,path=[(PJ2.x,PJ1.y)],start_straight=False,end_straight=False,width=L2_width,layer=M6)
        L3 = spira.RoutePath(port1=PJ2,port2=PN7,path=[((PJ2.x+PN7.x)/2,(PJ2.y+PN7.y)/2)],start_straight=False,end_straight=False,width=L3_width,layer=M6)
        L4 = spira.RoutePath(port1=PJ3,port2=PN7,path=[((PJ3.x+PN7.x)/2,(PJ3.y+PN7.y)/2)],start_straight=False,end_straight=False,width=L4_width,layer=M6)
        L5 = spira.RoutePath(port1=PQ0,port2=PJ3,path=[((PQ0.x+PJ3.x)/2,(PQ0.y+PJ3.y)/2)],start_straight=False,end_straight=False,width=IXports.reference.elements['Q0'].bbox_info.height,layer=M6)
        L5_post = spira.RoutePath(port1=PQ0_post,port2=PJ3,path=[((PQ0_post.x+PJ3.x)/2,(PQ0_post.y+PJ3.y)/2)],start_straight=False,end_straight=False,width=L5_width,layer=M6)
        L6 = spira.RoutePath(port1=PJ4,port2=PN7,path=[((PJ4.x+PN7.x)/2,(PJ4.y+PN7.y)/2)],start_straight=False,end_straight=False,width=L6_width,layer=M6)
        L7 = spira.RoutePath(port1=PQ1,port2=PJ4,path=[((PQ1.x+PJ4.x)/2,(PQ1.y+PJ4.y)/2)],start_straight=False,end_straight=False,width=IXports.reference.elements['Q1'].bbox_info.width,layer=M6)
        L7_post = spira.RoutePath(port1=PQ1_post,port2=PJ4,path=[((PQ1_post.x+PJ4.x)/2,(PQ1_post.y+PJ4.y)/2)],start_straight=False,end_straight=False,width=L7_width,layer=M6)
        ...
        LB1_2 = spira.RoutePath(port1=PB1N,port2=PB1_3_end,path=[((PB1N.x+PB1_3_end.x)/2,(PB1N.y+PB1_3_end.y)/2)],start_straight=False,end_straight=False,width=LB_width,layer=M6)
        LB2_1 = spira.RoutePath(port1=PJ2,port2=PB2E,path=[((PJ2.x+PB2E.x)/2,(PJ2.y+PB2E.y)/2)],start_straight=False,end_straight=False,width=LB_width,layer=M6)
        LB2_2 = spira.RoutePath(port1=PB2W,port2=PB2_4_end,path=[(PB2_4_end.x,PB2W.y)],start_straight=False,end_straight=False,width=LB_width,layer=M6)
        LB3_1 = spira.RoutePath(port1=PJ3,port2=PB3S,path=[((PJ3.x+PB3S.x)/2,(PJ3.y+PB3S.y)/2)],start_straight=False,end_straight=False,width=LB_width,layer=M6)
        LB3_2 = spira.RoutePath(port1=PB3N,port2=PB1_3_end,path=[(PB3N.x,PB1_3_end.y)],start_straight=False,end_straight=False,width=LB_width,layer=M6)
        LB4_1 = spira.RoutePath(port1=PJ4,port2=PB4E,path=[((PJ4.x+PB4E.x)/2,(PJ4.y+PB4E.y)/2)],start_straight=False,end_straight=False,width=LB_width,layer=M6)
        LB4_2 = spira.RoutePath(port1=PB4W,port2=PB2_4_end,path=[((PB4W.x+PB2_4_end.x)/2,(PB4W.y+PB2_4_end.y)/2)],start_straight=False,end_straight=False,width=LB_width,layer=M6)
...
class M0_tracks(spira.Cell):
    ...
    def create_elements(self, elems):
        ...
        elems += spira.Box(layer=M0,width=0.3*tp,height=5.0*tp,center=(1.5*tp,4.0*tp))
        ...
        elems += spira.Box(layer=M0,width=2.75*tp,height=0.04*tp,center=(3.5*tp,6.02*tp))
...
class M4M5M6M7_connections(spira.Cell):
    ...
    def create_elements(self, elems):
        ...
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(5.335*tp,3.735*tp))
        ...
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(0.335*tp,2.845*tp))
        ...
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(2.335*tp,4.04*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(2.335*tp,5.735*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(2.335*tp,4.855*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(0.93*tp,6.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(1.735*tp,4.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(1.125*tp,4.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(3.735*tp,4.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(1.93*tp,6.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(3.125*tp,0.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(0.93*tp,0.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(2.015*tp,4.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(1.015*tp,5.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(4.025*tp,4.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(3.735*tp,0.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(2.845*tp,4.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(1.93*tp,0.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(3.845*tp,5.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(3.735*tp,-0.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(1.125*tp,2.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(0.93*tp,1.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(3.125*tp,4.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(4.015*tp,2.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(3.93*tp,6.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(2.93*tp,6.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(3.735*tp,2.665*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r270,midpoint=(0.845*tp,2.665*tp))
...
class biasing(spira.Cell):
    ...
    def create_elements(self, elems):
        elems += spira.SRef(ls_ib_175(),midpoint=(3.5*tp,4.49*tp),alias="bias3")
        elems += spira.SRef(ls_ib_175(),midpoint=(1.5*tp,3.91*tp),alias="bias1")
        elems += spira.SRef(ls_ib_175(),transformation=r90,midpoint=(3.12*tp,1.5*tp),alias="bias4")
        elems += spira.SRef(ls_ib_280(),transformation=r90,midpoint=(2.145*tp,2.5*tp),alias="bias2")
        return elems
...
class junctions(spira.Cell):
    ...
    def create_elements(self, elems):
        ...
        elems += spira.SRef(ls_jj_250_sg(),transformation=r180,midpoint=(1.5*tp,3.5*tp),alias="J1")
        elems += spira.SRef(ls_jj_250_sg(),transformation=r270,midpoint=(3.5*tp,1.5*tp),alias="J4")
        elems += spira.SRef(ls_jj_300_sg(),transformation=r180,midpoint=(2.5*tp,2.5*tp),alias="J2")
        return elems
