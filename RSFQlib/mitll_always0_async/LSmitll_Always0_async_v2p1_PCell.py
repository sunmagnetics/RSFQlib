...
class PCELL(spira.PCell):
    ...
    def create_elements(self, elems):
        ...
        R2 = spira.SRef(ls_res_2(),midpoint=(2.5*tp,2.38*tp),alias='R2')
        ...
        ## Inductors
        L1 = spira.RoutePath(port1=PA,port2=PJ1,path=[((PA.x+PJ1.x)/2,(PA.y+PJ1.y)/2)],start_straight=False,end_straight=False,width=L1_width,layer=M6)
        ...
        L4 = spira.RoutePath(port1=PQ,port2=PJ2,path=[(3.5*tp,PQ.y),(3.5*tp,PJ2.y)],start_straight=False,end_straight=False,width=L4_width,layer=M6)
        ...
        LB1_2 = spira.RoutePath(port1=PB1N,port2=PBP,path=[(PB1N.x,PBP.y)],start_straight=False,end_straight=False,width=LB_width,layer=M6)
        LB2_1 = spira.RoutePath(port1=PJ2,port2=PB2S,path=[((PJ2.x+PB2S.x)/2,(PJ2.y+PB2S.y)/2)],start_straight=False,end_straight=False,width=LB_width,layer=M6)
...
class M0_tracks(spira.Cell):
    ...
    def create_elements(self, elems):
        elems += spira.Box(layer=M0,width=4.0*tp,height=0.3*tp,center=(2.0*tp,6.5*tp))
        elems += spira.Box(layer=M0,width=3.75*tp,height=0.04*tp,center=(2.0*tp,6.02*tp))
...
class junction_fill(spira.Cell):
    ...
    def create_elements(self, elems):
        ...
        elems += spira.SRef(ls_FakeJJ_3umx3um(),midpoint=(3.5*tp,2.5*tp))
        ...
        elems += spira.SRef(ls_FakeJJ_3umx3um(),midpoint=(0.5*tp,6*tp))
        ...
        elems += spira.SRef(ls_FakeJJ_3umx3um(),midpoint=(3.5*tp,6*tp))
        elems += spira.SRef(ls_FakeJJ_3umx3um(),midpoint=(3.5*tp,6.5*tp))
        elems += spira.SRef(ls_FakeJJ_3umx3um(),midpoint=(3.5*tp,2*tp))
...
class M4M5M6M7_connections(spira.Cell):
    ...
    def create_elements(self, elems):
        ...
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(2.335*tp,6.835*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(0.335*tp,3.735*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),midpoint=(3.335*tp,4.795*tp))
        ...
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(2.265*tp,5.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(2.875*tp,5.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(2.985*tp,6.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(3.875*tp,4.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(1.22*tp,6.335*tp))
        ...
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(2.875*tp,3.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(2.07*tp,0.335*tp))
        elems += spira.SRef(ls_conn_M4M5M6M7(),transformation=r90,midpoint=(3.195*tp,3.335*tp))
        ...
        elems += spira.SRef(ls_conn_M5M6M7(),transformation=r90,midpoint=(2.005*tp,4.465*tp))
        elems += spira.SRef(ls_conn_M5M6M7(),transformation=r270,midpoint=(1.995*tp,3.535*tp))
...
class biasing(spira.Cell):
    ...
    def create_elements(self, elems):
        elems += spira.SRef(ls_ib_175(),midpoint=(2.5*tp,4.96*tp),alias="bias2")
        elems += spira.SRef(ls_ib_175(),midpoint=(1.5*tp,4.5*tp),alias="bias1")
        return elems

class junctions(spira.Cell):
    __name_prefix__ = "junctions"
    def create_elements(self, elems):
        elems += spira.SRef(ls_jj_250_sg(),transformation=r90,midpoint=(2.5*tp,4.5*tp),alias="J2")
