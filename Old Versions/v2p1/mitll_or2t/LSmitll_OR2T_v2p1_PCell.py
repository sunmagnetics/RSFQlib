...
class PCELL(spira.PCell):
    ...
    def create_elements(self, elems):
        ...
        # LVS Labels
        elems += spira.Label(text='VDD',position=(8.504*tp,6.8245*tp),layer=spira.Layer(number=50,datatype=1))
        elems += spira.Label(text='GND',position=(8.6508*tp,6.8289*tp),layer=spira.Layer(number=40,datatype=1))
        elems += spira.Label(text='RIB1',position=(4.4784*tp,1.062*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RIB2',position=(4.5071*tp,5.9507*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RIB3',position=(2.0225*tp,3.4959*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RIB4',position=(5.507*tp,1.6265*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RIB5',position=(8.81*tp,4.5012*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RIB6',position=(9.4982*tp,2.582*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RIB7',position=(6.4976*tp,1.1099*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB1',position=(2.4978*tp,1.8442*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB2',position=(3.196*tp,2.535*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB3',position=(3.1638*tp,2.889*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB4',position=(2.4973*tp,5.1492*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB5',position=(3.1935*tp,4.4592*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB6',position=(3.1657*tp,4.1033*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB7',position=(4.1497*tp,3.8*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB8',position=(4.5087*tp,3.8093*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB9',position=(7.1297*tp,5.4909*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB10',position=(6.0578*tp,3.8644*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB11',position=(6.5009*tp,3.0351*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB12',position=(7.4961*tp,3.8297*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB13',position=(8.8155*tp,2.5524*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RB14',position=(7.439*tp,1.1991*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='RD',position=(7.8953*tp,1.4957*tp),layer=spira.Layer(number=52,datatype=1))
        elems += spira.Label(text='a',position=(1.4998*tp,1.4995*tp),layer=spira.Layer(number=60,datatype=1))
        elems += spira.Label(text='b',position=(1.5008*tp,5.501*tp),layer=spira.Layer(number=60,datatype=1))
        elems += spira.Label(text='clk',position=(8.5027*tp,5.5*tp),layer=spira.Layer(number=60,datatype=1))
        elems += spira.Label(text='q',position=(8.5025*tp,1.496*tp),layer=spira.Layer(number=60,datatype=1))
        return elems
